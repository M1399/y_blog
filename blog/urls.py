...
urlpatterns = [
    ...
    url(r'^commentsByAjax/(?P<article_id>[0-9]+)/$', views.commentsByAjax, name='commentsByAjax'),
    url(r'^addCommentsByAjax/(?P<article_id>[0-9]+)/$', views.addCommentsByAjax, name='addCommentsByAjax'),
